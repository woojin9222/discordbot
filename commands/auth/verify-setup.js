...
const verifiedCh   = interaction.options.getChannel(‘verified_channel’);
const title        = interaction.options.getString(‘title’) ?? ‘✅ 서버 인증’;
const description  = interaction.options.getString(‘description’) ??
‘아래 **인증하기** 버튼을 클릭하면\n자동으로 멤버 역할이 부여됩니다.’;

```
// 봇 멤버 캐시가 없을 수 있으므로 null 체크 후 역할 순서 검사
...
await interaction.reply({ embeds: [summaryEmbed], flags: ['Ephemeral'] });
```
